/* IPM (Inter-Processor Mailbox) sample application for x86 processor
...
QUARK_SE_IPM_DEFINE(ipm_receive_channel, 1, QUARK_SE_IPM_INBOUND);
QUARK_SE_IPM_DEFINE(ipm_send_channel, 0, QUARK_SE_IPM_OUTBOUND);
...
static const char *send_data = "Hey, it's x86!!";
